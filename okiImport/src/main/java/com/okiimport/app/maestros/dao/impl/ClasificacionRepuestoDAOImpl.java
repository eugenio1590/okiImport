...
public class ClasificacionRepuestoDAOImpl extends AbstractJpaDao<ClasificacionRepuesto, Integer>
		implements ClasificacionRepuestoDAO {
	
	public ClasificacionRepuestoDAOImpl() {
		super(ClasificacionRepuesto.class);
